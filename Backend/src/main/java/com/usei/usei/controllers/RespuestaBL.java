    ...
    private final RespuestaDAO respuestaDAO;
        private final PreguntaService preguntaService;
            private final EstudianteService estudianteService;
                ...
                @Autowired
                    public RespuestaBL(RespuestaDAO respuestaDAO, PreguntaService preguntaService, EstudianteService estudianteService) {
                                                                                                        ...
                                                                                                        @Transactional
                                                                                                            public Respuesta save(Respuesta respuesta) {
                                                                                                                    Pregunta pregunta = preguntaService.findById(respuesta.getPreguntaIdPregunta().getIdPregunta())
                                                                                                                                    .orElseThrow(() -> new RuntimeException("Pregunta no encontrada con el id: " + respuesta.getPreguntaIdPregunta().getIdPregunta()));

                                                                                                                                            Estudiante estudiante = estudianteService.findById(respuesta.getEstudianteIdEstudiante().getIdEstudiante())
                                                                                                                                                            .orElseThrow(() -> new RuntimeException("Estudiante no encontrado con el id: " + respuesta.getEstudianteIdEstudiante().getIdEstudiante()));
